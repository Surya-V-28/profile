  ...
  data: [
    {
      ...
      skills: [
        ...
        "⚡ Building responsive website front end using React and Spring Boot",
        "⚡ Creating application backend in Node, Next, MongoDB and Rest API",
  ...
  degrees: [
    ...
    },
    {
      ...
      descriptions: [
        ...
        "⚡ Secured 9.27CGPA and top among three of my class .",
        "⚡ Awarded christ university commendation scholarship for maintaining good academic and extra cariculam activties.",
      ],
    ...
    },
    {
      ...
      duration: "2018 - 2020",
      descriptions: [
        "⚡ I have studied 10th and 12th here, secured 95% in my 10th and 87% in 12th with highest score in mathematics",
...
const projects = {
  data: [
    ...
    },
    {
      ...
      description:
        "Built 3D shirt customization app with Three.js, allowing users to personalize designs with colors, logos, and full-image backgrounds.back end Integrated GPT-3.5 for AI-assisted, cutting-edge design experiences. Tech: JavaScripts, CSS, Tailwind, RestFul Api’s, GPT3.5,  Three.js, Next.js, Automation Testing(.",
      languages: [
        {
          name: "React",
          iconifyClass: "logos:react",
